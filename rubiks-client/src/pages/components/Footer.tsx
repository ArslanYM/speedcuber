...
export const Footer = () => {
  return (
    <>
    <footer className="mt-10 text-gray-600 font-mono">
  <div className="container px-4 md:px-32 lg:px-52 py-4 md:py-6 lg:py-8 flex flex-col md:flex-row justify-between items-center">
    ...
    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2024
      <a href="https://twitter.com/ArslanYMalik" className="font-mono text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@ArlanYM</a>
    </p>
    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      <a className="text-gray-900 cursor-pointer" href='https://github.com/ArslanYM'>
      ...
      <a href='https://twitter.com/ArsalanYmalik' className="ml-3 text-gray-900 cursor-pointer">
      ...
      <a href='https://www.linkedin.com/in/arsalan-malik-746913237/' className="ml-3 text-gray-900 cursor-pointer">
